...
public class ActionPdfAnnoDocCcl extends PopupAction {
	static Logger log = Logger.getLogger(PopiangWindow.class);

	String vid;
	public ActionPdfAnnoDocCcl(JPopupMenu pop, TextFileInfo tfi, String lb, String i) {
		super(pop, tfi, lb);
		vid = i;
	}
...
System.out.println("################## START ANALYSIS");
		...
		int i1,i2;
		String fnm = null;
		if("vo:PdfDoc".equals(tp) && (i1=vid.indexOf(":"))>0) {
...
System.out.println("  "+j+":["+ id2 + "]="+(cc2!=null));
			...
			String dsc,v0;
			String[] aProp = { "vp:name", "vp:seqNo","vp:DEN","vp:BusinessTerm","vp:Cardinality" };
